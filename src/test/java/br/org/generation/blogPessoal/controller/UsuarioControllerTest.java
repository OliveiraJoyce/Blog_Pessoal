...
public class UsuarioControllerTest {
	...
	public void start() throws ParseException {
        ...
        usuario = new Usuario(0L, "Paulo Antunes", "paulo2@email.com.br", "13465278", dataPost);
        
		LocalDate dataPut = LocalDate.parse("2000-07-22", DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        usuarioUpdate = new Usuario(9L, "Paulo Antunes de Souza", "paulo_silva@email.com.br", "souza123", dataPut);
	}
